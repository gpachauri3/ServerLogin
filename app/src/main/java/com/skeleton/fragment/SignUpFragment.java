...
public class SignUpFragment extends BaseFragment {
    ...
    private void init(final View view) {
        ...
        etPhoneNum = (MaterialEditText) view.findViewById(R.id.etPhoneNum);
    ...
    private void postData() {
        if (validateForm()) {
            ...
            RestClient.getApiInterface().register(params.getMap()).enqueue(new ResponseResolver<com.skeleton.model.SignUpResponse>(getContext()
                    , true) {
                @Override
                public void success(final com.skeleton.model.SignUpResponse signUpResponse) {
